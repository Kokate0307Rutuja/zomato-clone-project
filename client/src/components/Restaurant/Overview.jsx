        ...
        <div className="flex flex-col-reverse">
          ...
          <div className="my-4 w-full md:hidden flex flex-col gap-4">
            <MapView
              title="McDonald's"
              phno="+193423542345"
              mapLocation={getLatLong("18.537575983713907, 73.8982160138734")}
              address="6-3, Lane No. 6, Ashok Chakra Society, Meera Nagar, Koregaon Park, Pune, Maharashtra 411001"
            />
          </div>
        </div>
      </div>
